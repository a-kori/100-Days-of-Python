# ASCII art source: https://ascii.co.uk/art/treasuremap
print('''
...
if input("Enter a single letter a, b or c. All the other characters will be taken for wrong answers: ").lower() == "a" :
...
he won't let you through unless you tell him, which of the following phrases was actually improvised by the actor Johnny Depp, and have never been in 
...
a : Go deeper into the forest, which probabably full of berries, edible insects etc.
b : Find a nearby river to collect water.
c : Eat the Czech guy and tell no-one about it.
        ''')

        input = input("Your answer: ").lower()
...
enthusiasm, you continued your journey and finally found the treasure! Congratulations!''')
            ...
            print('Unusual choice! Too bad for you though, as you can\'t read the map and got lost in the woods afterwards... Ever thought about collecting berries?')
        else :
