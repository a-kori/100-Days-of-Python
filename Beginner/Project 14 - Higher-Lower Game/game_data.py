...
def get_high_score():
    ...
    file = open(HIGH_SCORE_RECORD_PATH, 'r')
    try:
...
def update_high_score(new_high_score : int):
    '''Overwrites the current high score of the game with the given argument in the high score record file.'''
    file = open(HIGH_SCORE_RECORD_PATH, 'w')
